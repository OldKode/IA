...
#came_from, cost_so_far = dijkstra_search(diagram4, (1, 4), (1, 10))
came_from, cost_so_far = a_star_search(diagram4, (1, 4), (7, 10))
#print(came_from)
#print(cost_so_far)
draw_grid(diagram4, width=3, point_to=came_from, start=(1, 4), goal=(7, 10))
print()
draw_grid(diagram4, width=3, number=cost_so_far, start=(1, 4), goal=(7, 10))
print()
draw_grid(diagram4, width=3, path=reconstruct_path(came_from, start=(1, 4), goal=(7, 10)))
